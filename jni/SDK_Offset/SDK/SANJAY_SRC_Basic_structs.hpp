...
struct FBattleItemAdditionalData
{
	...
	struct FString                                     StringData;                                               // 0x0008(0x000C) (BlueprintVisible, ZeroConstructor)
	float                                              FloatData;                                                // 0x0014(0x0004) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
struct FBattleItemUseTarget
{
	...
	class AActor*                                      TargetActor;                                              // 0x001C(0x0004) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
};
...
struct FBattleItemPickupInfo
{
	...
	bool                                               bDropOnDead;                                              // 0x0038(0x0001) (BlueprintVisible, ZeroConstructor, Transient, IsPlainOldData)
...
struct FBattleItemData : public FItemData
{
	...
	struct FBattleItemFeatureData                      FeatureData;                                              // 0x0064(0x002C) (BlueprintVisible)
	TArray<struct FItemAssociation>                    Associations;                                             // 0x0090(0x000C) (BlueprintVisible, ZeroConstructor)
...
struct FClientBaseInfo
{
	...
	TArray<int>                                        MrpcsData;                                                // 0x0080(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData03[0x4];                                       // 0x008C(0x0004) MISSED OFFSET
	TMap<int, struct FString>                          AdvConfig;                                                // 0x0090(0x0050) (ZeroConstructor)
	TMap<struct FString, class UTexture2D*>            AdvTextureList;                                           // 0x00CC(0x0050) (ZeroConstructor)
};
...
struct FAttributeExpand
{
	...
	int                                                nValue;                                                   // 0x002C(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      bValue;                                                   // 0x0030(0x0001) (ZeroConstructor, IsPlainOldData)
...
struct FAttrDesc
{
	...
	bool                                               bNeedSync;                                                // 0x000C(0x0001) (ZeroConstructor, IsPlainOldData, RepSkip, RepNotify, Interp, NonTransactional, EditorOnly, NoDestructor, AutoWeak, ContainsInstancedReference, AssetRegistrySearchable, SimpleDisplay, AdvancedDisplay, Protected, BlueprintCallable, BlueprintAuthorityOnly, TextExportTransient, NonPIEDuplicateTransient, ExposeOnSpawn, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, NativeAccessSpecifierProtected, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData00[0x3];                                       // 0x000D(0x0003) MISSED OFFSET
	float                                              CurValue;                                                 // 0x0010(0x0004) (ZeroConstructor, IsPlainOldData)
};
...
{
	struct FString                                     ModifyDesc;                                               // 0x0000(0x000C) (ZeroConstructor)
	int                                                NextIndex;                                                // 0x000C(0x0004) (ZeroConstructor, IsPlainOldData)
	TArray<struct FAttrModifyRecordDetail>             Data;                                                     // 0x0010(0x000C) (ZeroConstructor)
};
...
{
	struct FAttrDesc                                   AttrDesc;                                                 // 0x0000(0x0014)
	TArray<struct FAttrModifyRecordDetails>            DetailsArray;                                             // 0x0014(0x000C) (ZeroConstructor)
};
...
struct FAttrRegisterItem
{
	...
	unsigned char                                      UnknownData00[0x12];                                      // 0x0012(0x0012) MISSED OFFSET
};
...
struct FClientSyncBrief
{
	...
	float                                              Duration;                                                 // 0x0018(0x0004) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
...
{
	struct FClientSyncBrief                            Unit;                                                     // 0x0000(0x0020)
	bool                                               bMarkDelete;                                              // 0x0020(0x0001) (ZeroConstructor, IsPlainOldData)
...
{
	TArray<struct FBuffNetArrayUnit>                   IncArray;                                                 // 0x0000(0x000C) (ZeroConstructor)
...
struct FBuffTableRow
{
	...
	int                                                ModeOpen;                                                 // 0x00D8(0x0004) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FString                                     ModeStrings;                                              // 0x00DC(0x000C) (BlueprintVisible, ZeroConstructor)
};
...
{
	TArray<class AActor*>                              LevelActors;                                              // 0x0000(0x000C) (ZeroConstructor)
	float                                              CollectionTime;                                           // 0x000C(0x0004) (ZeroConstructor, IsPlainOldData)
};
...
struct FItemFixTableItem
{
	...
	struct FString                                     ExTime;                                                   // 0x0004(0x000C) (ZeroConstructor)
};
...
{
	TArray<struct FBattleItemSpectatingData>           PlayerThrowInfo;                                          // 0x0000(0x000C) (BlueprintVisible, ZeroConstructor)
	uint32_t                                           PlayerKey;                                                // 0x000C(0x0004) (ZeroConstructor, IsPlainOldData)
	uint32_t                                           TeamID;                                                   // 0x0010(0x0004) (ZeroConstructor, IsPlainOldData)
};
...
{
	TArray<struct FBattleItemSpectatingData>           PlayerBackPackInfo;                                       // 0x0000(0x000C) (BlueprintVisible, ZeroConstructor)
	int                                                MainWeapon1TypeSpecificID;                                // 0x000C(0x0004) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                MainWeapon1AmmoNuminClip;                                 // 0x0010(0x0004) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                MainWeapon2TypeSpecificID;                                // 0x0014(0x0004) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                MainWeapon2AmmoNuminClip;                                 // 0x0018(0x0004) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
struct FBattleItemPickupAfterLand
{
	...
	struct FBattleItemPickupInfo                       PickupInfo;                                               // 0x0018(0x0040) (BlueprintVisible)
	EBattleItemPickupReason                            Reason;                                                   // 0x0058(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	EBattleItemClientPickupType                        BattleItemClientPickupType;                               // 0x0059(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
struct FPickupProposeData
{
	...
	TArray<struct FPickupFirstCount>                   TaskPickFirst;                                            // 0x000C(0x000C) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	int                                                closeSubType;                                             // 0x0018(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                crossbowSubType;                                          // 0x001C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                panID;                                                    // 0x0020(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                pistolSubType;                                            // 0x0024(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                gunType;                                                  // 0x0028(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                specialType;                                              // 0x002C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                specialType2;                                             // 0x0030(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                lens2ID;                                                  // 0x0034(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                lens3ID;                                                  // 0x0038(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                lens4ID;                                                  // 0x003C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                lens6ID;                                                  // 0x0040(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                lens8ID;                                                  // 0x0044(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                ID2Type;                                                  // 0x0048(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                pistolClipSubType;                                        // 0x004C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                SubMachineGunClipSubType;                                 // 0x0050(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                SniperClipSubType;                                        // 0x0054(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                RifleClipSubType;                                         // 0x0058(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                gasSubID;                                                 // 0x005C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                backSubType;                                              // 0x0060(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                MedicalSubType;                                           // 0x0064(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                back3ID;                                                  // 0x0068(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                BandageID;                                                // 0x006C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                QuickBandageID;                                           // 0x0070(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                EnergyDrinksID;                                           // 0x0074(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                AdrenalineID;                                             // 0x0078(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                AnodyneID;                                                // 0x007C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                Medical1ID;                                               // 0x0080(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                QuickMedical1ID;                                          // 0x0084(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                Medical2ID;                                               // 0x0088(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                AntidoteID;                                               // 0x008C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                BatteryChipID;                                            // 0x0090(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                GameCoinID;                                               // 0x0094(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                ZhenBaoDan;                                               // 0x0098(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                YanWuDan;                                                 // 0x009C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                RanShaoPing;                                              // 0x00A0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                ShouLei;                                                  // 0x00A4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                FlarePistolID;                                            // 0x00A8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	TArray<int>                                        SideMirrorList;                                           // 0x00AC(0x000C) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	TArray<int>                                        MirrorList;                                               // 0x00B8(0x000C) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	int                                                ViscidityBomb;                                            // 0x00C4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                GrenadeZombie;                                            // 0x00C8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                GrenadeYedan;                                             // 0x00CC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                DefaultMedicineNum;                                       // 0x00D0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                helmetSubType;                                            // 0x00D4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                armorSubType;                                             // 0x00D8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                ScoreItemSubType;                                         // 0x00DC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                SpecialNoDropItemSubType;                                 // 0x00E0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                IceDrinkItemSubType;                                      // 0x00E4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                IsAutoPickUpTaskSubType;                                  // 0x00E8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                CapacityThreshold;                                        // 0x00EC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                GlideSubType;                                             // 0x00F0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                ParachuteItemSubType;                                     // 0x00F4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                revivalCardID;                                            // 0x00F8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                SnowManID;                                                // 0x00FC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              revivalCardValidTime;                                     // 0x0100(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	TArray<int>                                        firewoodPriority;                                         // 0x0104(0x000C) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	TArray<int>                                        meatPriority;                                             // 0x0110(0x000C) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	TArray<int>                                        UAVList;                                                  // 0x011C(0x000C) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	TArray<int>                                        ElectricityList;                                          // 0x0128(0x000C) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	TArray<int>                                        ToUseInBackpackSubList;                                   // 0x0134(0x000C) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	TArray<int>                                        ToUseInBackpackIDList;                                    // 0x0140(0x000C) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	TArray<int>                                        notExtractItemIDList;                                     // 0x014C(0x000C) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
};
...
struct FItemRecordData
{
	...
	struct FString                                     ItemWhiteIcon;                                            // 0x007C(0x000C) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	struct FString                                     RedEmotionSoundPath;                                      // 0x0088(0x000C) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	struct FString                                     PickupDesc;                                               // 0x0094(0x000C) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	struct FString                                     BackpackSimple;                                           // 0x00A0(0x000C) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	struct FString                                     SpecialIcon;                                              // 0x00AC(0x000C) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	struct FString                                     ItemBigIcon2;                                             // 0x00B8(0x000C) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	struct FString                                     ItemSmallIcon2;                                           // 0x00C4(0x000C) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
};
...
struct FSTBuffInstancedItem
{
	...
	unsigned char                                      UnknownData01[0x43];                                      // 0x0055(0x0043) MISSED OFFSET
};
...
{
	TArray<TWeakObjectPtr<class AActor>>               Actors;                                                   // 0x0000(0x000C) (ZeroConstructor)
};
