...
struct FUTSkillCreateData
{
	...
	TArray<class UUTSkillCDBase*>                      SkillCDs;                                                 // 0x0028(0x000C) (ZeroConstructor, Transient)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0034(0x0004) MISSED OFFSET
	TArray<class UUTSkillEventEffectMapForEditor*>     EditorEventEffectMap;                                     // 0x0038(0x000C) (ExportObject, ZeroConstructor, Transient)
};
...
{
	TArray<ESkillBlackboardResetRule>                  ResetRuleArray;                                           // 0x0098(0x000C) (Edit, BlueprintVisible, ZeroConstructor)
...
struct FUTSkillRuntimeData
{
	...
	TArray<class UUTSkillCDBase*>                      SkillCDs;                                                 // 0x000C(0x000C) (ZeroConstructor, Transient)
};
...
struct FUTSkillSyncData_CD
{
	...
	TArray<unsigned char>                              SkillSyncDatas;                                           // 0x0004(0x000C) (ZeroConstructor)
};
...
{
	unsigned char                                      UnknownData00[0x3C];                                      // 0x0000(0x003C) UNKNOWN PROPERTY: SetProperty Skill.SkillDisableKeySet.DisableKeySet
};
...
struct FUTMutilSkillSynData
{
	...
	TArray<unsigned char>                              PhaseIndexArray;                                          // 0x0018(0x000C) (Edit, BlueprintVisible, ZeroConstructor)
	TArray<unsigned char>                              BlackboardContent;                                        // 0x0024(0x000C) (Edit, BlueprintVisible, ZeroConstructor)
...
{
	TArray<struct FUTMutilSkillSynData>                DataList;                                                 // 0x0000(0x000C) (ZeroConstructor)
...
struct FUTSkillSynSinglePhaseData
{
	...
	TArray<unsigned char>                              BlackboardContent;                                        // 0x0014(0x000C) (Edit, BlueprintVisible, ZeroConstructor)
...
{
	TArray<struct FUTSkillSynSinglePhaseData>          DataList;                                                 // 0x0000(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData00[0x18];                                      // 0x000C(0x0018) MISSED OFFSET
};
...
struct FUTSkillSimulateData
{
	...
	TArray<int>                                        SimlatePhaseIndexs;                                       // 0x0010(0x000C) (ZeroConstructor)
...
struct FUTSkillStateSyncData
{
	...
	TArray<struct FUTSkillSyncData_CD>                 CDSyncDatas;                                              // 0x0010(0x000C) (ZeroConstructor)
};
...
struct FUTSkillPhaseCreateData
{
	...
	bool                                               bMustHasTarget;                                           // 0x0014(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bCoolDown;                                                // 0x0015(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x2];                                       // 0x0016(0x0002) MISSED OFFSET
	int                                                CoolDownIndex;                                            // 0x0018(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TArray<class UUTSkillCondition*>                   PhaseConditions;                                          // 0x001C(0x000C) (Edit, BlueprintVisible, ExportObject, ZeroConstructor, DisableEditOnInstance)
	class UUTSkillPicker*                              Picker;                                                   // 0x0028(0x0004) (Edit, BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	...
	int                                                JumpPhaseIndex;                                           // 0x0048(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TArray<struct FUAEBlackboardKeySelector>           SyncBBKArray;                                             // 0x004C(0x000C) (Edit, BlueprintVisible, ZeroConstructor)
	TArray<class UUTSkillEventEffectMapForEditor*>     EditorEventEffectMap;                                     // 0x0058(0x000C) (ExportObject, ZeroConstructor)
};
...
struct FSharedDelegateWrap
{
	...
	class UObject*                                     Outer;                                                    // 0x0004(0x0004) (ZeroConstructor, IsPlainOldData)
...
struct FLuaEventRegistWrap
{
	...
	class UObject*                                     Outer;                                                    // 0x001C(0x0004) (ZeroConstructor, IsPlainOldData)
...
{
	TArray<struct FName>                               KeyNames;                                                 // 0x0000(0x000C) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
};
...
struct FUTSkillInstance
{
	...
	TArray<TEnumAsByte<EUTSkillEventType>>             EventCache;                                               // 0x002C(0x000C) (ZeroConstructor)
	struct FUTSkillCreateData                          SkillBaseData;                                            // 0x0038(0x0044)
	TWeakObjectPtr<class AUTSkill>                     CurSkill;                                                 // 0x007C(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	TWeakObjectPtr<class UUTSkillWidget>               CurSkillWidget;                                           // 0x0084(0x0008) (ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData)
	TWeakObjectPtr<class UUTSkillManagerComponent>     OwnerComp;                                                // 0x008C(0x0008) (ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData)
	bool                                               bGsListener;                                              // 0x0094(0x0001) (ZeroConstructor, IsPlainOldData)
