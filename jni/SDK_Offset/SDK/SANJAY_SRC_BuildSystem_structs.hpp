...
struct FBuildingData
{
	...
	TArray<TEnumAsByte<ECollisionChannel>>             BlockingChannels;                                         // 0x0020(0x000C) (Edit, BlueprintVisible, ZeroConstructor)
	...
	bool                                               bAutoRefreshCD;                                           // 0x0038(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x0039(0x0003) MISSED OFFSET
	int                                                GroupBuildingIdForMaxBuild;                               // 0x003C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
};
