...
{
public:
	unsigned char                                      UnknownData00[0x3C];                                      // 0x00D8(0x003C) MISSED OFFSET
	TArray<struct FString>                             LuaCommandList;                                           // 0x0114(0x000C) (BlueprintVisible, ZeroConstructor)
...
public:
	...
	TArray<class UGMCheatSystem*>                      GMCheatSystems;                                           // 0x009C(0x000C) (ZeroConstructor)
	class AActor*                                      PVETestMonster;                                           // 0x00A8(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x2C];                                      // 0x00AC(0x002C) MISSED OFFSET
	TArray<class ASkeletalMeshActor*>                  SkeletalMeshActorPool;                                    // 0x00D8(0x000C) (ZeroConstructor)
...
{
public:
	float                                              MaxDrawTimePerTask;                                       // 0x00C8(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x64];                                      // 0x00CC(0x0064) MISSED OFFSET
