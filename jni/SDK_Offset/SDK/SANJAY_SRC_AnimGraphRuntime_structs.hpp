...
struct FPoseBlendEnumData
{
	...
	TArray<float>                                      OtherPosesBlendTime;                                      // 0x0010(0x000C) (Edit, EditFixedSize, ZeroConstructor)
...
struct FAnimNode_BlendListByEnumAdvance : public FAnimNode_BlendListBase
{
	...
	TArray<struct FPoseBlendEnumData>                  PosesBlendTimeSetup;                                      // 0x00A4(0x000C) (Edit, EditFixedSize, ZeroConstructor)
};
...
struct FAnimNode_BoneRetarget : public FAnimNode_Base
{
	...
	bool                                               bUseAsMasterNode;                                         // 0x0074(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bUseRetargetFeature;                                      // 0x0075(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
struct FAnimNode_Fabrik : public FAnimNode_SkeletalControlBase
{
	...
	TEnumAsByte<EBoneRotationSource>                   EffectorRotationSource;                                   // 0x0140(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
// 0x0AA8 (0x0B00 - 0x0058)
struct FAnimNode_QuadrupedTerrainAdapting : public FAnimNode_SkeletalControlBase
{
	bool                                               bEnable;                                                  // 0x0058(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bDrawDebug;                                               // 0x0059(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x2];                                       // 0x005A(0x0002) MISSED OFFSET
	float                                              RayTrace_SphereRadius;                                    // 0x005C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FBoneSocketTarget                           RayTrace_LHandBottom;                                     // 0x0060(0x0060) (Edit)
	struct FBoneSocketTarget                           RayTrace_RHandBottom;                                     // 0x00C0(0x0060) (Edit)
	struct FBoneSocketTarget                           RayTrace_LFootBottom;                                     // 0x0120(0x0060) (Edit)
	struct FBoneSocketTarget                           RayTrace_RFootBottom;                                     // 0x0180(0x0060) (Edit)
	bool                                               bEnableSlopeAdapting;                                     // 0x01E0(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bEnableLionDanceSlopeAdapting;                            // 0x01E1(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x6];                                       // 0x01E2(0x0006) MISSED OFFSET
	struct FBoneReference                              SlopeAdapting_Pelvis;                                     // 0x01E8(0x0018) (Edit, BlueprintVisible)
	struct FBoneReference                              SlopeAdapting_Pelvis1;                                    // 0x0200(0x0018) (Edit, BlueprintVisible)
	struct FBoneReference                              SlopeAdapting_Pelvis2;                                    // 0x0218(0x0018) (Edit, BlueprintVisible)
	struct FBoneReference                              SlopeAdapting_LClavicle;                                  // 0x0230(0x0018) (Edit, BlueprintVisible)
	struct FBoneReference                              SlopeAdapting_RClavicle;                                  // 0x0248(0x0018) (Edit, BlueprintVisible)
	struct FBoneReference                              SlopeAdapting_LThigh;                                     // 0x0260(0x0018) (Edit, BlueprintVisible)
	struct FBoneReference                              SlopeAdapting_RThigh;                                     // 0x0278(0x0018) (Edit, BlueprintVisible)
	struct FBoneReference                              SlopeAdapting_Root;                                       // 0x0290(0x0018) (Edit, BlueprintVisible)
	float                                              SlopeAdapting_PelvisLimitHeight;                          // 0x02A8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              SlopeAdapting_LimitSlopeAngle;                            // 0x02AC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              SlopeAdapting_PositionLerpSpeed;                          // 0x02B0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              SlopeAdapting_RotationLerpSpeed;                          // 0x02B4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              SlopeAdapting_BehindLegModifyFactor;                      // 0x02B8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bEnableLegAdapting;                                       // 0x02BC(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x3];                                       // 0x02BD(0x0003) MISSED OFFSET
	float                                              LegAdapting_IKLerpSpeed;                                  // 0x02C0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              LegAdapting_IKMaxHeight;                                  // 0x02C4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x8];                                       // 0x02C8(0x0008) MISSED OFFSET
	struct FAnimNode_TwoBoneIK                         LegAdapting_LHand;                                        // 0x02D0(0x01A0) (Edit, BlueprintVisible)
	struct FAnimNode_TwoBoneIK                         LegAdapting_RHand;                                        // 0x0470(0x01A0) (Edit, BlueprintVisible)
	struct FAnimNode_TwoBoneIK                         LegAdapting_LFoot;                                        // 0x0610(0x01A0) (Edit, BlueprintVisible)
	struct FAnimNode_TwoBoneIK                         LegAdapting_RFoot;                                        // 0x07B0(0x01A0) (Edit, BlueprintVisible)
	bool                                               bEnableLionDanceLegAdapting;                              // 0x0950(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bEnableFootAdapting;                                      // 0x0951(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x6];                                       // 0x0952(0x0006) MISSED OFFSET
	struct FBoneReference                              FootAdapting_LHand;                                       // 0x0958(0x0018) (Edit, BlueprintVisible)
	struct FBoneReference                              FootAdapting_RHand;                                       // 0x0970(0x0018) (Edit, BlueprintVisible)
	struct FBoneReference                              FootAdapting_LFoot;                                       // 0x0988(0x0018) (Edit, BlueprintVisible)
	struct FBoneReference                              FootAdapting_RFoot;                                       // 0x09A0(0x0018) (Edit, BlueprintVisible)
	struct FRotator                                    FootAdapting_LimitRotation;                               // 0x09B8(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
	float                                              FootAdapting_RotationLerpSpeed;                           // 0x09C4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0x138];                                     // 0x09C8(0x0138) MISSED OFFSET
};
...
{
	struct FBoneReference                              BoneToModify;                                             // 0x0058(0x0018) (Edit)
	struct FRotator                                    RotationLimitMin;                                         // 0x0070(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
	struct FRotator                                    RotationLimitMax;                                         // 0x007C(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
};
...
struct FAnimNode_SequenceEvaluator : public FAnimNode_AssetPlayerBase
{
	...
	TEnumAsByte<ESequenceEvalTimeType>                 ExplicitTimeType;                                         // 0x0058(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bShouldLoop;                                              // 0x0059(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bTeleportToExplicitTime;                                  // 0x005A(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
{
	unsigned char                                      UnknownData00[0x160];                                     // 0x0420(0x0160) MISSED OFFSET
};
