...
public:
	...
	struct FString                                     ProjectBranch;                                            // 0x0098(0x000C) (Edit, ZeroConstructor, Config)
	struct FString                                     SupportContact;                                           // 0x00A4(0x000C) (Edit, ZeroConstructor, Config)
	struct FText                                       ProjectDisplayedTitle;                                    // 0x00B0(0x000C) (Edit, Config)
	struct FText                                       ProjectDebugTitleInfo;                                    // 0x00BC(0x000C) (Edit, Config)
	bool                                               bShouldWindowPreserveAspectRatio;                         // 0x00C8(0x0001) (Edit, ZeroConstructor, Config, IsPlainOldData)
	bool                                               bUseBorderlessWindow;                                     // 0x00C9(0x0001) (Edit, ZeroConstructor, Config, IsPlainOldData)
	bool                                               bStartInVR;                                               // 0x00CA(0x0001) (Edit, ZeroConstructor, Config, IsPlainOldData)
	bool                                               bStartInAR;                                               // 0x00CB(0x0001) (Edit, ZeroConstructor, Config, IsPlainOldData)
	bool                                               bAllowWindowResize;                                       // 0x00CC(0x0001) (Edit, ZeroConstructor, Config, IsPlainOldData)
	bool                                               bAllowClose;                                              // 0x00CD(0x0001) (Edit, ZeroConstructor, Config, IsPlainOldData)
	bool                                               bAllowMaximize;                                           // 0x00CE(0x0001) (Edit, ZeroConstructor, Config, IsPlainOldData)
	bool                                               bAllowMinimize;                                           // 0x00CF(0x0001) (Edit, ZeroConstructor, Config, IsPlainOldData)
