...
{
public:
	class UUIParticleAsset*                            Asset;                                                    // 0x00D0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FScriptMulticastDelegate                    EventOnEnd;                                               // 0x00D4(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      bPlayParticle : 1;                                        // 0x00E0(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly)
	bool                                               IsPlaying;                                                // 0x00E1(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnTemplate, EditConst, IsPlainOldData)
...
{
public:
	class UUIParticleEmitterAsset*                     Asset;                                                    // 0x00D0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FScriptMulticastDelegate                    EventOnEnd;                                               // 0x00D4(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      bPlayParticle : 1;                                        // 0x00E0(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly)
	bool                                               IsPlaying;                                                // 0x00E1(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnTemplate, EditConst, IsPlainOldData)
	unsigned char                                      UnknownData00[0xE];                                       // 0x00E2(0x000E) MISSED OFFSET
