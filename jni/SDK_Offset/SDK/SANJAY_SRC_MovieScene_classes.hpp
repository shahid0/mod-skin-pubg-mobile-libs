...
public:
	...
	bool                                               bLowDeviceFrameRateLimitEnabled;                          // 0x00AC(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x00AD(0x0003) MISSED OFFSET
	int                                                LowDeviceFrameLimit;                                      // 0x00B0(0x0004) (ZeroConstructor, IsPlainOldData)
...
public:
	...
	TEnumAsByte<EMovieScenePlayerStatus>               Status;                                                   // 0x0338(0x0001) (ZeroConstructor, IsPlainOldData)
	...
	unsigned char                                      UnknownData04[0x2CC];                                     // 0x037C(0x02CC) MISSED OFFSET
