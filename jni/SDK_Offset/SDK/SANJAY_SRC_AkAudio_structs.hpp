...
{
	TArray<struct FString>                             EventList;                                                // 0x0000(0x000C) (ZeroConstructor)
	TMap<struct FString, float>                        RTPCList;                                                 // 0x000C(0x0050) (ZeroConstructor)
	TMap<struct FString, struct FString>               SwitchList;                                               // 0x0048(0x0050) (ZeroConstructor)
};
...
struct FAKFunctionInfo
{
	...
	struct FString                                     StrParam;                                                 // 0x000C(0x000C) (ZeroConstructor)
	int                                                NumParam;                                                 // 0x0018(0x0004) (ZeroConstructor, IsPlainOldData)
};
...
struct FAKErrorInfo
{
	...
	TArray<struct FAKFunctionInfo>                     DetailInfo;                                               // 0x0004(0x000C) (ZeroConstructor)
};
...
struct FAudioOfflineVisualBeatData
{
	...
	TArray<float>                                      Intensity;                                                // 0x0004(0x000C) (Edit, BlueprintVisible, ZeroConstructor)
};
