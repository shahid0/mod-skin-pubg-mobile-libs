...
{
	int                                                Status;                                                   // 0x002C(0x0004) (ZeroConstructor, IsPlainOldData)
	struct FString                                     Channel;                                                  // 0x0030(0x000C) (ZeroConstructor)
};
...
{
	struct FString                                     codeId;                                                   // 0x002C(0x000C) (ZeroConstructor)
	struct FString                                     randStr;                                                  // 0x0038(0x000C) (ZeroConstructor)
	int                                                nextAt;                                                   // 0x0044(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                expireAt;                                                 // 0x0048(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                createAt;                                                 // 0x004C(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                queryInterval;                                            // 0x0050(0x0004) (ZeroConstructor, IsPlainOldData)
	struct FString                                     codeData;                                                 // 0x0054(0x000C) (ZeroConstructor)
};
...
{
	struct FString                                     captcha;                                                  // 0x002C(0x000C) (ZeroConstructor)
};
