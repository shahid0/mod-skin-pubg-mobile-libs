...
{
public:
	TArray<struct FProcMeshSection>                    ProcMeshSections;                                         // 0x06A0(0x000C) (ZeroConstructor)
	TArray<struct FKConvexElem>                        CollisionConvexElems;                                     // 0x06AC(0x000C) (ZeroConstructor)
	struct FBoxSphereBounds                            LocalBounds;                                              // 0x06B8(0x001C) (IsPlainOldData)
	TArray<class UBodySetup*>                          AsyncBodySetupQueue;                                      // 0x06D4(0x000C) (ZeroConstructor, Transient)
