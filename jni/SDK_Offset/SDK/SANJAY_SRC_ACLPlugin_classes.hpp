...
{
public:
	TEnumAsByte<EACLCompressionLevel>                  CompressionLevel;                                         // 0x0030(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
public:
	...
	TEnumAsByte<EACLCompressionLevel>                  CompressionLevel;                                         // 0x0038(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EACLRotationFormat>                    RotationFormat;                                           // 0x0039(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EACLVectorFormat>                      TranslationFormat;                                        // 0x003A(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EACLVectorFormat>                      ScaleFormat;                                              // 0x003B(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
