...
struct FComboButtonStyle : public FSlateWidgetStyle
{
	...
	float                                              ArrowPaddingLeft;                                         // 0x0358(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              ArrowPaddingRight;                                        // 0x035C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              ArrowPaddingTop;                                          // 0x0360(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              ArrowPaddingBottom;                                       // 0x0364(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FSlateBrush                                 MenuBorderBrush;                                          // 0x0368(0x0098) (Edit, BlueprintVisible)
	struct FMargin                                     MenuBorderPadding;                                        // 0x0400(0x0010) (Edit, BlueprintVisible, IsPlainOldData)
};

// ScriptStruct SlateCore.ComboBoxStyle
// 0x0444 (0x0448 - 0x0004)
struct FComboBoxStyle : public FSlateWidgetStyle
{
	unsigned char                                      UnknownData00[0x4];                                       // 0x0004(0x0004) MISSED OFFSET
	struct FComboButtonStyle                           ComboButtonStyle;                                         // 0x0008(0x0410) (Edit, BlueprintVisible)
	struct FSlateSound                                 PressedSlateSound;                                        // 0x0418(0x0018) (Edit, BlueprintVisible)
	struct FSlateSound                                 SelectionChangeSlateSound;                                // 0x0430(0x0018) (Edit, BlueprintVisible)
};
