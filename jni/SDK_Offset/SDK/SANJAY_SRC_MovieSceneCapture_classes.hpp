...
public:
	...
	struct FMovieSceneCaptureSettings                  Settings;                                                 // 0x0034(0x0040) (Edit, Config)
	unsigned char                                      UnknownData01[0xC];                                       // 0x0074(0x000C) MISSED OFFSET
	bool                                               bUseSeparateProcess;                                      // 0x0080(0x0001) (Edit, ZeroConstructor, Config, IsPlainOldData)
	bool                                               bCloseEditorWhenCaptureStarts;                            // 0x0081(0x0001) (Edit, ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData02[0x2];                                       // 0x0082(0x0002) MISSED OFFSET
	struct FString                                     AdditionalCommandLineArguments;                           // 0x0084(0x000C) (Edit, ZeroConstructor, Config)
	struct FString                                     InheritedCommandLineArguments;                            // 0x0090(0x000C) (Edit, ZeroConstructor, Transient)
	unsigned char                                      UnknownData03[0xDC];                                      // 0x009C(0x00DC) MISSED OFFSET
...
public:
	...
	TEnumAsByte<EHDRCaptureGamut>                      CaptureGamut;                                             // 0x0030(0x0001) (Edit, ZeroConstructor, Config, IsPlainOldData)
...
{
public:
	bool                                               bAutoStartCapture;                                        // 0x0178(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0xB];                                       // 0x0179(0x000B) MISSED OFFSET
	struct FGuid                                       PrerequisiteActorId;                                      // 0x0184(0x0010) (IsPlainOldData)
