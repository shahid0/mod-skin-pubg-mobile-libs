...
{
public:
	unsigned char                                      UnknownData00[0xE0];                                      // 0x0680(0x00E0) MISSED OFFSET
	unsigned char                                      bForceSolo : 1;                                           // 0x0760(0x0001) (Edit)
	unsigned char                                      UnknownData01[0x1C];                                      // 0x0761(0x001C) MISSED OFFSET
	unsigned char                                      bAutoDestroy : 1;                                         // 0x077D(0x0001)
	unsigned char                                      bRenderingEnabled : 1;                                    // 0x077D(0x0001)
	unsigned char                                      bAutoManageAttachment : 1;                                // 0x077D(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly)
	unsigned char                                      UnknownData02[0x2];                                       // 0x077E(0x0002) MISSED OFFSET
	struct FScriptMulticastDelegate                    OnSystemFinished;                                         // 0x0780(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	TWeakObjectPtr<class USceneComponent>              AutoAttachParent;                                         // 0x078C(0x0008) (Edit, BlueprintVisible, ExportObject, ZeroConstructor, DisableEditOnTemplate, EditConst, InstancedReference, IsPlainOldData)
	...
	unsigned char                                      UnknownData04[0x1];                                       // 0x07A3(0x0001) MISSED OFFSET
	int                                                PreviewDetailLevel;                                       // 0x07A4(0x0004) (Edit, ZeroConstructor, Transient, IsPlainOldData)
	float                                              PreviewLODDistance;                                       // 0x07A8(0x0004) (Edit, ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      bEnablePreviewDetailLevel : 1;                            // 0x07AC(0x0001) (Edit, Transient)
	unsigned char                                      bEnablePreviewLODDistance : 1;                            // 0x07AC(0x0001) (Edit, Transient)
	unsigned char                                      UnknownData05[0x33];                                      // 0x07AD(0x0033) MISSED OFFSET
...
{
public:
	class UNiagaraComponent*                           NiagaraComponent;                                         // 0x0310(0x0004) (Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData)
...
{
public:
	class UNiagaraSystem*                              System;                                                   // 0x0310(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	ENiagaraPreviewGridResetMode                       ResetMode;                                                // 0x0314(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0315(0x0003) MISSED OFFSET
	class UNiagaraPreviewAxis*                         PreviewAxisX;                                             // 0x0318(0x0004) (Edit, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UNiagaraPreviewAxis*                         PreviewAxisY;                                             // 0x031C(0x0004) (Edit, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UClass*                                      PreviewClass;                                             // 0x0320(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              SpacingX;                                                 // 0x0324(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              SpacingY;                                                 // 0x0328(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                NumX;                                                     // 0x032C(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
	int                                                NumY;                                                     // 0x0330(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
	TArray<class UChildActorComponent*>                PreviewComponents;                                        // 0x0334(0x000C) (ExportObject, ZeroConstructor, Transient)
...
public:
	...
	unsigned char                                      UnknownData01[0x11C];                                     // 0x02F0(0x011C) MISSED OFFSET
	struct FNiagaraVMExecutableData                    CachedScriptVM;                                           // 0x040C(0x00C0)
	TArray<class UNiagaraParameterCollection*>         CachedParameterCollectionReferences;                      // 0x04CC(0x000C) (ZeroConstructor)
	TArray<struct FNiagaraScriptDataInterfaceInfo>     CachedDefaultDataInterfaces;                              // 0x04D8(0x000C) (ZeroConstructor)
