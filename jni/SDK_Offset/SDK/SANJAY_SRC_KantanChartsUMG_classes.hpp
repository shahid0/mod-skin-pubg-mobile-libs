...
{
public:
	struct FMargin                                     Margins;                                                  // 0x00D0(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, IsPlainOldData)
	struct FText                                       ChartTitle;                                               // 0x00E0(0x000C) (Edit, BlueprintVisible, BlueprintReadOnly)
	struct FMargin                                     TitlePadding;                                             // 0x00EC(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, IsPlainOldData)
	float                                              UpdateTickRate;                                           // 0x00FC(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
...
{
public:
	bool                                               bAutoPerCategoryStyles;                                   // 0x0108(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0109(0x0003) MISSED OFFSET
	class UKantanCategoryStyleSet*                     CategoryStyleSet;                                         // 0x010C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	TArray<struct FCategoryStyleManualMapping>         ManualStyleMappings;                                      // 0x0110(0x000C) (Edit, ZeroConstructor)
...
{
public:
	struct FKantanBarChartStyle                        WidgetStyle;                                              // 0x0120(0x0120) (Edit, BlueprintVisible)
	EKantanBarChartOrientation                         Orientation;                                              // 0x0240(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0241(0x0003) MISSED OFFSET
	float                                              MaxBarValue;                                              // 0x0244(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	EKantanBarLabelPosition                            LabelPosition;                                            // 0x0248(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x0249(0x0003) MISSED OFFSET
	float                                              BarToGapRatio;                                            // 0x024C(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	EKantanBarValueExtents                             ValueExtentsDisplay;                                      // 0x0250(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x3];                                       // 0x0251(0x0003) MISSED OFFSET
	struct FCartesianAxisConfig                        ValueAxisCfg;                                             // 0x0254(0x002C) (Edit, BlueprintVisible, BlueprintReadOnly)
...
{
public:
	class UObject*                                     DataSource;                                               // 0x0280(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
...
public:
	...
	TEnumAsByte<EKantanDataPointSize>                  DataPointSize;                                            // 0x024C(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
...
public:
	struct FMargin                                     Margins;                                                  // 0x00D0(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, IsPlainOldData)
	struct FMargin                                     SeriesPadding;                                            // 0x00E0(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, IsPlainOldData)
