...
struct FMovieSceneSpawnable
{
	...
	ESpawnDeviceLevel                                  DeviceLevel;                                              // 0x002D(0x0001) (ZeroConstructor, IsPlainOldData)
	ESpawnUserQualitySettingLevel                      UserQualitySettingLevel;                                  // 0x002E(0x0001) (ZeroConstructor, IsPlainOldData)
