...
struct FMovieScene3DPathSectionTemplate : public FMovieSceneEvalTemplate
{
	...
	unsigned char                                      bUseConstantVelocity : 1;                                 // 0x0072(0x0001)
...
// 0x0058 (0x0064 - 0x000C)
struct FMovieScenePrimitiveMaterialTemplate : public FMovieSceneEvalTemplate
{
	int                                                MaterialIndex;                                            // 0x000C(0x0004) (ZeroConstructor, IsPlainOldData)
	struct FIntegralCurve                              BoolCurve;                                                // 0x0010(0x0054)
};
