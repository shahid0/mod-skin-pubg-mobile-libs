...
struct FMapRenderConfig
{
	...
	struct FOverrideRenderConfig                       OverrideRenderConfig;                                     // 0x001C(0x0004) (IsPlainOldData)
	struct FRenderConfig                               RenderConfig;                                             // 0x0020(0x0070)
};
...
struct FShaderGroupDesc
{
	...
	struct FString                                     Parent;                                                   // 0x0010(0x000C) (ZeroConstructor, Config)
	unsigned char                                      UnknownData01[0x10];                                      // 0x001C(0x0010) MISSED OFFSET
};
...
{
	TArray<struct FString>                             Include;                                                  // 0x002C(0x000C) (ZeroConstructor, Config)
	TArray<struct FString>                             Quality;                                                  // 0x0038(0x000C) (ZeroConstructor, Config)
};
...
{
	TArray<struct FString>                             Include;                                                  // 0x002C(0x000C) (ZeroConstructor, Config)
	TArray<struct FString>                             Exclude;                                                  // 0x0038(0x000C) (ZeroConstructor, Config)
};
