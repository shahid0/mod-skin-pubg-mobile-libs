...
public:
	...
	struct FString                                     PUBLISH_AREA;                                             // 0x0020(0x000C) (ZeroConstructor, Config)
	struct FString                                     IMSDK_GAME_ID;                                            // 0x002C(0x000C) (ZeroConstructor, Config)
	struct FString                                     GEMAppID;                                                 // 0x0038(0x000C) (ZeroConstructor, Config)
	uint32_t                                           TSSGameId;                                                // 0x0044(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	uint64_t                                           GameID;                                                   // 0x0048(0x0008) (ZeroConstructor, Config, IsPlainOldData)
	struct FString                                     GameKey;                                                  // 0x0050(0x000C) (ZeroConstructor, Config)
	unsigned char                                      UnknownData01[0x4];                                       // 0x005C(0x0004) MISSED OFFSET
	uint64_t                                           VoiceSdkGameId;                                           // 0x0060(0x0008) (ZeroConstructor, Config, IsPlainOldData)
	struct FString                                     VoiceSdkGameKey;                                          // 0x0068(0x000C) (ZeroConstructor, Config)
	struct FString                                     APPID_FACEBOOK;                                           // 0x0074(0x000C) (ZeroConstructor, Config)
	struct FString                                     APPID_APPLE;                                              // 0x0080(0x000C) (ZeroConstructor, Config)
	struct FString                                     APPID_GOOGLE;                                             // 0x008C(0x000C) (ZeroConstructor, Config)
	struct FString                                     APPID_TWITTER;                                            // 0x0098(0x000C) (ZeroConstructor, Config)
	struct FString                                     APPID_NosCHAT;                                            // 0x00A4(0x000C) (ZeroConstructor, Config)
	struct FString                                     APPID_VK;                                                 // 0x00B0(0x000C) (ZeroConstructor, Config)
	struct FString                                     APPID_LINE;                                               // 0x00BC(0x000C) (ZeroConstructor, Config)
	struct FString                                     APPID_BgBg;                                               // 0x00C8(0x000C) (ZeroConstructor, Config)
	struct FString                                     GUID_GAMEMASTER;                                          // 0x00D4(0x000C) (ZeroConstructor, Config)
	struct FString                                     GEMCtrlURL;                                               // 0x00E0(0x000C) (ZeroConstructor, Config)
	struct FString                                     TMFPCtrlURL;                                              // 0x00EC(0x000C) (ZeroConstructor, Config)
	int                                                SubsideFeatureLevel;                                      // 0x00F8(0x0004) (ZeroConstructor, Config, IsPlainOldData)
...
public:
	...
	struct FScriptMulticastDelegate                    AfterLoad;                                                // 0x0028(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnCancelled;                                              // 0x0034(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
...
public:
	...
	struct FPlayerInfoData                             PlayerInfoData;                                           // 0x0028(0x00A0)
	struct FPlayerAvatarData                           PlayerAvatarData;                                         // 0x00C8(0x0010)
	TMap<int, struct FWeaponDIYData>                   WeaponDIYData;                                            // 0x00D8(0x0050) (ZeroConstructor)
	class UBattleUtils*                                OwningBattleUtils;                                        // 0x0114(0x0004) (ZeroConstructor, IsPlainOldData)
...
public:
	...
	class UGameFrontendHUD*                            OwningFrontendHUD;                                        // 0x005C(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x10];                                      // 0x0060(0x0010) MISSED OFFSET
	class AUAEGameMode*                                BattleGameMode;                                           // 0x0070(0x0004) (ZeroConstructor, IsPlainOldData)
	TArray<class UBattlePlayer*>                       BattlePlayerList;                                         // 0x0074(0x000C) (ZeroConstructor)
	struct FBattleGameInfo                             CachedBattleGameInfo;                                     // 0x0080(0x0030)
	struct FGameModeAIPlayerParams                     CachedAIPlayerParams;                                     // 0x00B0(0x0338)
	struct FString                                     LuaFilePath;                                              // 0x03E8(0x000C) (ZeroConstructor, Config)
	unsigned char                                      UnknownData02[0x3C];                                      // 0x03F4(0x003C) MISSED OFFSET
...
public:
	...
	struct FString                                     CentauriIdc;                                              // 0x0048(0x000C) (ZeroConstructor)
...
// 0x0680 (0x07E8 - 0x0168)
class UGameFrontendHUD : public UFrontendHUD
{
public:
	unsigned char                                      UnknownData00[0x8];                                       // 0x0168(0x0008) MISSED OFFSET
	struct FScriptMulticastDelegate                    OnGetTicketNotifyDelegate;                                // 0x0170(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnHandleServerListDownload;                               // 0x017C(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnUIStatReport;                                           // 0x0188(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnCloudGMReceive;                                         // 0x0194(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnReportClientTool;                                       // 0x01A0(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FString                                     CSVTableRelativeDir;                                      // 0x01AC(0x000C) (ZeroConstructor, Config)
	TMap<struct FString, struct FString>               GameStatusMap;                                            // 0x01B8(0x0050) (ZeroConstructor)
	bool                                               EnableTickLog;                                            // 0x01F4(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData01[0x1];                                       // 0x01F5(0x0001) MISSED OFFSET
	bool                                               bEnableReportMemory;                                      // 0x01F6(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData02[0x15];                                      // 0x01F7(0x0015) MISSED OFFSET
	class UVoiceSDKInterface*                          VoiceSDK;                                                 // 0x020C(0x0004) (ZeroConstructor, IsPlainOldData)
	class UBugReporter*                                GameBugReporter;                                          // 0x0210(0x0004) (ZeroConstructor, IsPlainOldData)
	class UGMLogShare*                                 LogShare;                                                 // 0x0214(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                MaxUpdateRetryTimes;                                      // 0x0218(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData03[0x8];                                       // 0x021C(0x0008) MISSED OFFSET
	class UGDolphinUpdater*                            GDolphin;                                                 // 0x0224(0x0004) (ZeroConstructor, IsPlainOldData)
	class UTranslator*                                 Translator;                                               // 0x0228(0x0004) (ZeroConstructor, IsPlainOldData)
	class UHttpWrapper*                                HttpWrapper;                                              // 0x022C(0x0004) (ZeroConstructor, IsPlainOldData)
	...
	unsigned char                                      UnknownData06[0x13];                                      // 0x028D(0x0013) MISSED OFFSET
	class UCDNUpdate*                                  CDNUpdater;                                               // 0x02A0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                ODPaksPoolSize;                                           // 0x02A4(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	int                                                ODPaksPoolSizeLowend;                                     // 0x02A8(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	int                                                ODPaksPoolSizeLowendThreshold;                            // 0x02AC(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               ODPaksEnable;                                             // 0x02B0(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData07[0x1B];                                      // 0x02B1(0x001B) MISSED OFFSET
	TScriptInterface<class UClientNetInterface>        ClientNetInterface;                                       // 0x02CC(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData08[0x4];                                       // 0x02D4(0x0004) MISSED OFFSET
	struct FName                                       UnrealNetworkStatus;                                      // 0x02D8(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData09[0x10];                                      // 0x02E0(0x0010) MISSED OFFSET
	float                                              UnrealNetworkConnectingTimer;                             // 0x02F0(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData10[0xC];                                       // 0x02F4(0x000C) MISSED OFFSET
	float                                              UnrealNetworkConnectingTime;                              // 0x0300(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bUseDynamicCreateLuaManager;                              // 0x0304(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData11[0x3];                                       // 0x0305(0x0003) MISSED OFFSET
	TArray<struct FString>                             PersistentLuaManager;                                     // 0x0308(0x000C) (ZeroConstructor, Config)
	unsigned char                                      UnknownData12[0x4];                                       // 0x0314(0x0004) MISSED OFFSET
	bool                                               bPatchReInitSequence;                                     // 0x0318(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData13[0x3];                                       // 0x0319(0x0003) MISSED OFFSET
	class ULuaStateWrapper*                            LuaStateWrapper;                                          // 0x031C(0x0004) (ZeroConstructor, IsPlainOldData)
	class ULuaEventBridge*                             LuaEventBridgeInstace;                                    // 0x0320(0x0004) (ZeroConstructor, IsPlainOldData)
	class UBattleWindowMgrLuaUtils*                    LuaBattleWindowMgr;                                       // 0x0324(0x0004) (ZeroConstructor, IsPlainOldData)
	class ULuaBlueprintMgr*                            LuaBlueprintSysMgr;                                       // 0x0328(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData14[0x4];                                       // 0x032C(0x0004) MISSED OFFSET
	struct FString                                     ScriptBPRelativeDir;                                      // 0x0330(0x000C) (ZeroConstructor, Config)
	struct FString                                     ScriptRelativeDir;                                        // 0x033C(0x000C) (ZeroConstructor, Config)
	struct FString                                     InGameLuaDir;                                             // 0x0348(0x000C) (ZeroConstructor, Config)
	struct FString                                     PreloadLuaFileRelativePath;                               // 0x0354(0x000C) (ZeroConstructor, Config)
	TArray<struct FString>                             LuaDirList;                                               // 0x0360(0x000C) (ZeroConstructor, Config)
	TArray<struct FString>                             NoGCPackage;                                              // 0x036C(0x000C) (ZeroConstructor, Config)
	float                                              LuaTickTime;                                              // 0x0378(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bCallLuaTick;                                             // 0x037C(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bAutoLoginEnable;                                         // 0x037D(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData15[0x22];                                      // 0x037E(0x0022) MISSED OFFSET
	...
	int                                                PlayerStatusReportIntervalSecond;                         // 0x03AC(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	int                                                LossArraySyncIntervalSecond;                              // 0x03B0(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData16[0x4];                                       // 0x03B4(0x0004) MISSED OFFSET
	int                                                vmInstrumentOptimization;                                 // 0x03B8(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	class UTssManager*                                 TssMgr;                                                   // 0x03BC(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData17[0x24];                                      // 0x03C0(0x0024) MISSED OFFSET
	float                                              PingReportInterval;                                       // 0x03E4(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData18[0xD8];                                      // 0x03E8(0x00D8) MISSED OFFSET
	int64_t                                            DeactivatedThreshold;                                     // 0x04C0(0x0008) (ZeroConstructor, Config, IsPlainOldData)
	int64_t                                            TimePassThreshold;                                        // 0x04C8(0x0008) (ZeroConstructor, Config, IsPlainOldData)
	uint32_t                                           ImageDownloadClearDayCount;                               // 0x04D0(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	struct FScriptMulticastDelegate                    UIStackChangeDelegate;                                    // 0x04D4(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    UIStackRecoverDelegate;                                   // 0x04E0(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnFRefreshAdaptationUIEvent;                              // 0x04EC(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnFRefreshAdaptationExUIEvent;                            // 0x04F8(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    EnterBattleStageDelegate;                                 // 0x0504(0x000C) (ZeroConstructor, InstancedReference)
	struct FScriptMulticastDelegate                    OnAfterInitedDolphinDelegate;                             // 0x0510(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnDolphinVersionInfoDelegate;                             // 0x051C(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnDolphinNoticeInstallApkDelegate;                        // 0x0528(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnDolphinProgressDelegate;                                // 0x0534(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnDolphinErrorDelegate;                                   // 0x0540(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnRepairOverMaxTimesDelegate;                             // 0x054C(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnUpdateFinishedDelegate;                                 // 0x0558(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnRestartGameDelegate;                                    // 0x0564(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnInitIMSDKEnvDelegate;                                   // 0x0570(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnGetEnableCDNGetVersionDelegate;                         // 0x057C(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnAfterLoadedEditorLoginDelegate;                         // 0x0588(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnClearUIBeforeReInitLuaStateDelegate;                    // 0x0594(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnInitStateDelegate;                                      // 0x05A0(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnStartPufferUpdateDelegage;                              // 0x05AC(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnGetUpdateStateCDNConfigUrlDelegate;                     // 0x05B8(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnGetCDNUpdateInfoDelegate;                               // 0x05C4(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnQuickLoginDelegate;                                     // 0x05D0(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnGetRegionNoByCountryNoDelegate;                         // 0x05DC(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnPhoneMailLoginCallbackDelegate;                         // 0x05E8(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnLoginSDKCallbackDelegate;                               // 0x05F4(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData19[0x98];                                      // 0x0600(0x0098) MISSED OFFSET
	class UImageDownloader*                            ImageDownloaderInGame;                                    // 0x0698(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                FpsForWindowClient;                                       // 0x069C(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	class UUDPPingCollector*                           UDPPingCollector;                                         // 0x06A0(0x0004) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               UIElemLayoutJsonConfigSwitch;                             // 0x06A4(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               NationAllSwitch;                                          // 0x06A5(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               NationBattleSwitch;                                       // 0x06A6(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               NationRankSwitch;                                         // 0x06A7(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               SelfieSwitch;                                             // 0x06A8(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               ReportBugSwitch;                                          // 0x06A9(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               FirstVoicePopupSwitch;                                    // 0x06AA(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               GDPRForbidVoiceSwitch;                                    // 0x06AB(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               GDPRSettingSwitch;                                        // 0x06AC(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData20[0x3];                                       // 0x06AD(0x0003) MISSED OFFSET
	int                                                GDPRUserType;                                             // 0x06B0(0x0004) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               bShouldShowAdaptTipInLobby;                               // 0x06B4(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData21[0x3];                                       // 0x06B5(0x0003) MISSED OFFSET
	float                                              fLaggingFPSDiffThreshold;                                 // 0x06B8(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              fLaggingFPSDiffThresholdMin;                              // 0x06BC(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              fLaggingFPSDiffThresholdMax;                              // 0x06C0(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              fLaggingFrameTimeThreshold;                               // 0x06C4(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              fLaggingFrameTimeThresholdMin;                            // 0x06C8(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              fLaggingFrameTimeThresholdMax;                            // 0x06CC(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              fFPSReportInterval;                                       // 0x06D0(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData22[0x10];                                      // 0x06D4(0x0010) MISSED OFFSET
	bool                                               bUnLoadNoGcPackage;                                       // 0x06E4(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData23[0x3];                                       // 0x06E5(0x0003) MISSED OFFSET
	TArray<class UPackage*>                            NoGcPackages;                                             // 0x06E8(0x000C) (ZeroConstructor)
	bool                                               bFlushAsyncLoadingBeforeGC;                               // 0x06F4(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bEnablePandora;                                           // 0x06F5(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData24[0x1];                                       // 0x06F6(0x0001) MISSED OFFSET
	bool                                               bEnableJMLog;                                             // 0x06F7(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData25[0x84];                                      // 0x06F8(0x0084) MISSED OFFSET
	bool                                               bEnableH5Cache;                                           // 0x077C(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bCheckWorldNameForLoadConfig;                             // 0x077D(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData26[0x6];                                       // 0x077E(0x0006) MISSED OFFSET
	class UColorBlindnessMgr*                          ColorBlindnessMgrInstace;                                 // 0x0784(0x0004) (ZeroConstructor, IsPlainOldData)
	TArray<struct FNativeHUDTickContainer>             NativeHUDTickList;                                        // 0x0788(0x000C) (ZeroConstructor)
	bool                                               IsNativeHUDTickLock;                                      // 0x0794(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               IsShutDown;                                               // 0x0795(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData27[0x2];                                       // 0x0796(0x0002) MISSED OFFSET
	int                                                NativeHUDTickIndex;                                       // 0x0798(0x0004) (ZeroConstructor, IsPlainOldData)
	class UAsyncLoadHelper*                            AsyncLoadHelper;                                          // 0x079C(0x0004) (ZeroConstructor, IsPlainOldData)
	struct FString                                     BattleUtilsClassName;                                     // 0x07A0(0x000C) (ZeroConstructor, Config)
	class UBattleUtils*                                BattleUtils;                                              // 0x07AC(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData28[0x8];                                       // 0x07B0(0x0008) MISSED OFFSET
	struct FScriptDelegate                             OnImagePickDetectEvent;                                   // 0x07B8(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnPermissionResultEvent;                                  // 0x07C8(0x0010) (ZeroConstructor, InstancedReference)
	struct FString                                     CurrentMapName;                                           // 0x07D8(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData29[0x4];                                       // 0x07E4(0x0004) MISSED OFFSET
...
public:
	...
	unsigned char                                      UnknownData01[0xA0];                                      // 0x008C(0x00A0) MISSED OFFSET
	bool                                               AllowIOSBGDownload;                                       // 0x012C(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               AllowIOSBGDownloadPush;                                   // 0x012D(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               DisableJPKRBGDownloadNightPush;                           // 0x012E(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData02[0x1];                                       // 0x012F(0x0001) MISSED OFFSET
	int                                                DisableJPKRBGDownloadNightPushAfterHour;                  // 0x0130(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	int                                                DisableJPKRBGDownloadNightPushBeforeHour;                 // 0x0134(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	int                                                IOSBGDownloadPushDelaySeconds;                            // 0x0138(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               EnableRandomBackupURL;                                    // 0x013C(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               EnablePufferUpdate;                                       // 0x013D(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData03[0x12];                                      // 0x013E(0x0012) MISSED OFFSET
	struct FString                                     UpdateInfoPath;                                           // 0x0150(0x000C) (ZeroConstructor, Config)
	bool                                               OpenDebugLog;                                             // 0x015C(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData04[0x14B];                                     // 0x015D(0x014B) MISSED OFFSET
...
public:
	unsigned char                                      UnknownData00[0xC];                                       // 0x001C(0x000C) MISSED OFFSET
	struct FScriptMulticastDelegate                    OnImageDownloadResponseEvent;                             // 0x0028(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData01[0x4C];                                      // 0x0034(0x004C) MISSED OFFSET
...
public:
	...
	struct FString                                     CompreesedFileUrl;                                        // 0x0040(0x000C) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
	struct FString                                     FileSavePath;                                             // 0x004C(0x000C) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
	struct FString                                     CompreesedFileSavePath;                                   // 0x0058(0x000C) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
	struct FString                                     UrlHash;                                                  // 0x0064(0x000C) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
	struct FString                                     CompreesedUrlHash;                                        // 0x0070(0x000C) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
	bool                                               InvalidImageFormat;                                       // 0x007C(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               SaveDiskFile;                                             // 0x007D(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               ForceUpdate;                                              // 0x007E(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
public:
	unsigned char                                      UnknownData00[0xC];                                       // 0x001C(0x000C) MISSED OFFSET
	struct FString                                     IntlSdkUrl;                                               // 0x0028(0x000C) (ZeroConstructor, Config)
	struct FString                                     IntlSdkUrlDebug;                                          // 0x0034(0x000C) (ZeroConstructor, Config)
	struct FString                                     IntlSdkKey;                                               // 0x0040(0x000C) (ZeroConstructor, Config)
	bool                                               IntlSdkEnable;                                            // 0x004C(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               IntlLogEnable;                                            // 0x004D(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData01[0x2];                                       // 0x004E(0x0002) MISSED OFFSET
	struct FString                                     IntlHttpDnsIP;                                            // 0x0050(0x000C) (ZeroConstructor, Config)
	struct FString                                     IntlPf;                                                   // 0x005C(0x000C) (ZeroConstructor, Config)
...
{
public:
	unsigned char                                      UnknownData00[0x2];                                       // 0x0320(0x0002) MISSED OFFSET
	bool                                               bClearSourceCodeAfterInitialized;                         // 0x0322(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData01[0x25];                                      // 0x0323(0x0025) MISSED OFFSET
...
{
public:
	int                                                InvalidateFrameCount;                                     // 0x00E0(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	...
	bool                                               IgnoreStretch;                                            // 0x00EC(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               UpdateRenderTarget;                                       // 0x00ED(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x2];                                       // 0x00EE(0x0002) MISSED OFFSET
	int                                                MaskType;                                                 // 0x00F0(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	struct FVector2D                                   MaskTransformPivot;                                       // 0x00F4(0x0008) (Edit, BlueprintVisible, IsPlainOldData)
	struct FVector2D                                   MaskTransformScale;                                       // 0x00FC(0x0008) (Edit, BlueprintVisible, IsPlainOldData)
	float                                              MaskTransformAngle;                                       // 0x0104(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UMaterialInterface*                          MaskMaterial;                                             // 0x0108(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	class UTexture2D*                                  MaskTexture;                                              // 0x010C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
{
public:
	struct FVector2D                                   MaskTransformPivot;                                       // 0x0208(0x0008) (Edit, BlueprintVisible, IsPlainOldData)
	struct FVector2D                                   MaskTransformScale;                                       // 0x0210(0x0008) (Edit, BlueprintVisible, IsPlainOldData)
	float                                              MaskTransformAngle;                                       // 0x0218(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UMaterialInterface*                          MaskMaterial;                                             // 0x021C(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	class UTexture2D*                                  MaskTexture;                                              // 0x0220(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
{
public:
	EButtonClickSoundTypes                             ClickSound;                                               // 0x0440(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
...
public:
	unsigned char                                      UnknownData00[0xC];                                       // 0x001C(0x000C) MISSED OFFSET
	struct FScriptDelegate                             OnMouseButtonUp;                                          // 0x0028(0x0010) (ZeroConstructor, InstancedReference)
...
{
public:
	bool                                               bUseRegisterDelegateOptimize;                             // 0x0020(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0021(0x0003) MISSED OFFSET
	TMap<struct FString, bool>                         CacheRegisterProperties_Bool;                             // 0x0024(0x0050) (ZeroConstructor)
	TMap<struct FString, int>                          CacheRegisterProperties_Int;                              // 0x0060(0x0050) (ZeroConstructor)
	TMap<struct FString, float>                        CacheRegisterProperties_Float;                            // 0x009C(0x0050) (ZeroConstructor)
	struct FString                                     CachedSaveGameName;                                       // 0x00D8(0x000C) (ZeroConstructor, Config)
	TArray<struct FCustomSettingSaveGame>              CustomSettingSaveGames;                                   // 0x00E4(0x000C) (ZeroConstructor)
	struct FScriptDelegate                             GetUserSettingsDelegate;                                  // 0x00F0(0x0010) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, InstancedReference)
	class UEffectSettingMgr*                           EffectSettingMgrInstace;                                  // 0x0100(0x0004) (ZeroConstructor, IsPlainOldData)
	class USaveGame*                                   UserSettings;                                             // 0x0104(0x0004) (ZeroConstructor, IsPlainOldData)
	class UClass*                                      UserSettingsClass;                                        // 0x0108(0x0004) (ZeroConstructor, IsPlainOldData)
	struct FString                                     UserSettingsClassName;                                    // 0x010C(0x000C) (ZeroConstructor, Config)
	struct FString                                     ActiveSaveGameName;                                       // 0x0118(0x000C) (ZeroConstructor, Config)
	unsigned char                                      UnknownData01[0x4];                                       // 0x0124(0x0004) MISSED OFFSET
	struct FString                                     LanguageSettingsClassName;                                // 0x0128(0x000C) (ZeroConstructor, Config)
	struct FString                                     LanguageSaveGameName;                                     // 0x0134(0x000C) (ZeroConstructor, Config)
	unsigned char                                      UnknownData02[0x48];                                      // 0x0140(0x0048) MISSED OFFSET
	TMap<struct FString, bool>                         LanguageMap;                                              // 0x0188(0x0050) (ZeroConstructor)
...
public:
	...
	TMap<int, struct FAssetAsyncRequest>               PendingAsyncAssetRequests;                                // 0x00B8(0x0050) (ZeroConstructor)
...
public:
	...
	struct FScriptMulticastDelegate                    OnHyperlinkClicked;                                       // 0x00D4(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FString                                     ContentText;                                              // 0x00E0(0x000C) (Edit, ZeroConstructor)
	unsigned char                                      UnknownData01[0xC];                                       // 0x00EC(0x000C) MISSED OFFSET
	...
	TEnumAsByte<ETextJustify>                          Justification;                                            // 0x014C(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<ETextVerticalJustify>                  TextVerticalJustification;                                // 0x014D(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               AutoWrapText;                                             // 0x014E(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x1];                                       // 0x014F(0x0001) MISSED OFFSET
	...
	unsigned char                                      UnknownData04[0x1F4];                                     // 0x070C(0x01F4) MISSED OFFSET
	class UGameFrontendHUD*                            GameFrontendHUD;                                          // 0x0900(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0x4];                                       // 0x0904(0x0004) MISSED OFFSET
...
public:
	...
	bool                                               IsPassMouseEvent;                                         // 0x03C3(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	struct FString                                     ButtonVar;                                                // 0x03C4(0x000C) (Edit, BlueprintVisible, ZeroConstructor)
	struct FScriptMulticastDelegate                    OnButtonClicked;                                          // 0x03D0(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnButtonPressed;                                          // 0x03DC(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnButtonReleased;                                         // 0x03E8(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnButtonHovered;                                          // 0x03F4(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnButtonUnhovered;                                        // 0x0400(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	...
	struct FScriptMulticastDelegate                    OnClicked;                                                // 0x0428(0x000C) (ZeroConstructor, InstancedReference)
	struct FScriptMulticastDelegate                    OnPressed;                                                // 0x0434(0x000C) (ZeroConstructor, InstancedReference)
	struct FScriptMulticastDelegate                    OnReleased;                                               // 0x0440(0x000C) (ZeroConstructor, InstancedReference)
	struct FScriptMulticastDelegate                    OnHovered;                                                // 0x044C(0x000C) (ZeroConstructor, InstancedReference)
	struct FScriptMulticastDelegate                    OnUnhovered;                                              // 0x0458(0x000C) (ZeroConstructor, InstancedReference)
...
// 0x0A50 (0x0C58 - 0x0208)
class UReuseFallC : public UUserWidget
{
public:
	unsigned char                                      UnknownData00[0x8];                                       // 0x0208(0x0008) MISSED OFFSET
	struct FScriptMulticastDelegate                    OnAfterNewItem;                                           // 0x0210(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnRefreshItem;                                            // 0x021C(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnItemCreated;                                            // 0x0228(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnTouchFinish;                                            // 0x0234(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnOverscrollState;                                        // 0x0240(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData01[0x4];                                       // 0x024C(0x0004) MISSED OFFSET
	struct FScrollBoxStyle                             ScrollBoxStyle;                                           // 0x0250(0x0268) (Edit)
	EWidgetClipping                                    ScrollBoxClipping;                                        // 0x04B8(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x7];                                       // 0x04B9(0x0007) MISSED OFFSET
	struct FScrollBarStyle                             ScrollBarStyle;                                           // 0x04C0(0x0560) (Edit)
	ESlateVisibility                                   ScrollBarVisibility;                                      // 0x0A20(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x3];                                       // 0x0A21(0x0003) MISSED OFFSET
	struct FVector2D                                   ScrollbarThickness;                                       // 0x0A24(0x0008) (Edit, IsPlainOldData)
	int                                                ColumnNum;                                                // 0x0A2C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                ItemHeight;                                               // 0x0A30(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                ItemPaddingX;                                             // 0x0A34(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                ItemPaddingY;                                             // 0x0A38(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              OverscrollLength;                                         // 0x0A3C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	class UClass*                                      ItemClass;                                                // 0x0A40(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	TMap<struct FString, class UClass*>                OtherItemClass;                                           // 0x0A44(0x0050) (Edit, ZeroConstructor)
	int                                                PreviewCount;                                             // 0x0A80(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                ItemPoolMaxNum;                                           // 0x0A84(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                TopSpaceReserved;                                         // 0x0A88(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                BottomSpaceReserved;                                      // 0x0A8C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x34];                                      // 0x0A90(0x0034) MISSED OFFSET
	class UClass*                                      CurItemClass;                                             // 0x0AC4(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0x190];                                     // 0x0AC8(0x0190) MISSED OFFSET
...
// 0x0900 (0x0B08 - 0x0208)
class UReuseListC : public UUserWidget
{
public:
	unsigned char                                      UnknownData00[0x8];                                       // 0x0208(0x0008) MISSED OFFSET
	struct FScriptMulticastDelegate                    OnUpdateItem;                                             // 0x0210(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnScrollItem;                                             // 0x021C(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnCreateItem;                                             // 0x0228(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData01[0x4];                                       // 0x0234(0x0004) MISSED OFFSET
	struct FScrollBoxStyle                             ScrollBoxStyle;                                           // 0x0238(0x0268) (Edit)
	EWidgetClipping                                    ScrollBoxClipping;                                        // 0x04A0(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	ESlateVisibility                                   ScrollBoxVisibility;                                      // 0x04A1(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x6];                                       // 0x04A2(0x0006) MISSED OFFSET
	struct FScrollBarStyle                             ScrollBarStyle;                                           // 0x04A8(0x0560) (Edit)
	ESlateVisibility                                   ScrollBarVisibility;                                      // 0x0A08(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x3];                                       // 0x0A09(0x0003) MISSED OFFSET
	struct FVector2D                                   ScrollbarThickness;                                       // 0x0A0C(0x0008) (Edit, IsPlainOldData)
	int                                                ItemWidth;                                                // 0x0A14(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                ItemHeight;                                               // 0x0A18(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                PaddingX;                                                 // 0x0A1C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                PaddingY;                                                 // 0x0A20(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                TitleSize;                                                // 0x0A24(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                TitlePadding;                                             // 0x0A28(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               AutoTitleSize;                                            // 0x0A2C(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	EReuseListStyle                                    Style;                                                    // 0x0A2D(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x2];                                       // 0x0A2E(0x0002) MISSED OFFSET
	class UClass*                                      ItemClass;                                                // 0x0A30(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                PreviewCount;                                             // 0x0A34(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	EReuseListNotFullAlignStyle                        NotFullAlignStyle;                                        // 0x0A38(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               NotFullScrollBoxHitTestInvisible;                         // 0x0A39(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               UpdateForceLayoutPrepass;                                 // 0x0A3A(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0x1];                                       // 0x0A3B(0x0001) MISSED OFFSET
	int                                                ItemCacheNum;                                             // 0x0A3C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                DelayUpdateTimeLimitMS;                                   // 0x0A40(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData06[0xC4];                                      // 0x0A44(0x00C4) MISSED OFFSET
...
public:
	unsigned char                                      UnknownData00[0x8];                                       // 0x0208(0x0008) MISSED OFFSET
	struct FScriptMulticastDelegate                    OnPageChanged;                                            // 0x0210(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnCreateItem;                                             // 0x021C(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnBeginDrag;                                              // 0x0228(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnEndDrag;                                                // 0x0234(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnEndScroll;                                              // 0x0240(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	class UClass*                                      ItemClass;                                                // 0x024C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      IsLoopPage : 1;                                           // 0x0250(0x0001) (Edit)
	unsigned char                                      IsVertical : 1;                                           // 0x0250(0x0001) (Edit)
	unsigned char                                      CanDrag : 1;                                              // 0x0250(0x0001) (Edit)
	unsigned char                                      UnknownData01[0x3];                                       // 0x0251(0x0003) MISSED OFFSET
	int                                                CanDragLimit;                                             // 0x0254(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              AutoPlayRate;                                             // 0x0258(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                ShowPageNum;                                              // 0x025C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                DragPageNum;                                              // 0x0260(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              DChgPageParam;                                            // 0x0264(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              ScrollInertial;                                           // 0x0268(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              ScrollRate;                                               // 0x026C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x98];                                      // 0x0270(0x0098) MISSED OFFSET
...
public:
	unsigned char                                      UnknownData00[0x8];                                       // 0x0020(0x0008) MISSED OFFSET
	struct FString                                     ClassPath;                                                // 0x0028(0x000C) (Edit, ZeroConstructor, Config)
	struct FString                                     VibrateAssetTablePath;                                    // 0x0034(0x000C) (Edit, ZeroConstructor, Config)
	int                                                MaxAmplitude;                                             // 0x0040(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	int                                                GroundSpesificMatVibrationMinGrear;                       // 0x0044(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	float                                              VehicleBreakingMinSpeedThreshold;                         // 0x0048(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	float                                              VehicleGearMinSpeedThreshold;                             // 0x004C(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	TArray<int>                                        TriggerVehicleVibrateGroundPhysicMatList;                 // 0x0050(0x000C) (Edit, ZeroConstructor, Config)
	float                                              TriggerVehicleVibrateMinSlip;                             // 0x005C(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	float                                              TriggerVehicleVibrateMinSuspensionRaisePercent;           // 0x0060(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	float                                              VehicleRaiseSuspensionVibrateInerval;                     // 0x0064(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	int                                                InitAssetProccessNumFrames;                               // 0x0068(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	struct FString                                     LoopTime;                                                 // 0x006C(0x000C) (Edit, BlueprintVisible, ZeroConstructor, Config)
	unsigned char                                      UnknownData01[0x3C];                                      // 0x0078(0x003C) MISSED OFFSET
	TMap<int, EVibrateTriggerEventType>                LoadedVibrateAssetIDAndEventTypeMap;                      // 0x00B4(0x0050) (ZeroConstructor)
	TMap<EVibrateStrengthLevel, float>                 VibrateStrengthLevelModifireMap;                          // 0x00F0(0x0050) (Edit, BlueprintVisible, ZeroConstructor)
	TMap<EVibrateTriggerEventType, float>              VibrateEventMinIntervalMap;                               // 0x012C(0x0050) (Edit, BlueprintVisible, ZeroConstructor)
	TArray<EVibrateTriggerEventType>                   CharacterVibrateEventList;                                // 0x0168(0x000C) (Edit, BlueprintVisible, ZeroConstructor)
	TArray<EVibrateTriggerEventType>                   WeaponVibrateEventList;                                   // 0x0174(0x000C) (Edit, BlueprintVisible, ZeroConstructor)
	TArray<EVibrateTriggerEventType>                   VehicleVibrateEventList;                                  // 0x0180(0x000C) (Edit, BlueprintVisible, ZeroConstructor)
	TArray<EVibrateTriggerEventType>                   SoundUIVibrateEventList;                                  // 0x018C(0x000C) (Edit, BlueprintVisible, ZeroConstructor)
	TArray<EVibrateTriggerEventType>                   CharacterBeHitVibrateEventList;                           // 0x0198(0x000C) (Edit, BlueprintVisible, ZeroConstructor)
	TArray<EVibrateTriggerEventType>                   VehicleEngineVibrateEventList;                            // 0x01A4(0x000C) (Edit, BlueprintVisible, ZeroConstructor)
	TArray<EVibrateTriggerEventType>                   VehicleBeHitVibrateEventList;                             // 0x01B0(0x000C) (Edit, BlueprintVisible, ZeroConstructor)
	bool                                               bEntireVibrationSwitch;                                   // 0x01BC(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bCharacterVibrationSwitch;                                // 0x01BD(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bWeaponVibrationSwitch;                                   // 0x01BE(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bVehicleVibrationSwitch;                                  // 0x01BF(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bSoundUIVibrationSwitch;                                  // 0x01C0(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x3];                                       // 0x01C1(0x0003) MISSED OFFSET
	int                                                CharacterVibrationLevel;                                  // 0x01C4(0x0004) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                WeaponVibrationLevel;                                     // 0x01C8(0x0004) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                VehicleVibrationLevel;                                    // 0x01CC(0x0004) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                SoundUIVibrationLevel;                                    // 0x01D0(0x0004) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                EntireVibrationLevel;                                     // 0x01D4(0x0004) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bCharacterVibrate;                                        // 0x01D8(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bWeaponVibrate;                                           // 0x01D9(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bVehicleVibrate;                                          // 0x01DA(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bSoundUIVibrate;                                          // 0x01DB(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bCharacterBeHitVibrate;                                   // 0x01DC(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bCharacterClimbVibrate;                                   // 0x01DD(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bCharacterFallVibrate;                                    // 0x01DE(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bCharacterSwimVibrate;                                    // 0x01DF(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bAutoWeaponVibrate;                                       // 0x01E0(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bSemiAutoWeaponVibrate;                                   // 0x01E1(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bBoltWeaponVibrate;                                       // 0x01E2(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bOtherWeaponVibrate;                                      // 0x01E3(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bVehicleEngineVibrate;                                    // 0x01E4(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bVehicleBeHitVibrate;                                     // 0x01E5(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bVehicleCrashVibrate;                                     // 0x01E6(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bFootstepSoundUIVibrate;                                  // 0x01E7(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bFireShotSoundUIVibrate;                                  // 0x01E8(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bGlassBrokenSoundUIVibrate;                               // 0x01E9(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bVehicleSoundUIVibrate;                                   // 0x01EA(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x5];                                       // 0x01EB(0x0005) MISSED OFFSET
	struct FTimerHandle                                StopVibrateHandle;                                        // 0x01F0(0x0008) (BlueprintVisible)
	int                                                CurPlayingVibrateAssetIndex;                              // 0x01F8(0x0004) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                CurLoopPlayingVibrateAssetIndex;                          // 0x01FC(0x0004) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                DeviceSupportVibrateType;                                 // 0x0200(0x0004) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bInGameVibration;                                         // 0x0204(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bIsHandBreaking;                                          // 0x0205(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x3E];                                      // 0x0206(0x003E) MISSED OFFSET
	bool                                               bHasLastVehicle;                                          // 0x0244(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0x3];                                       // 0x0245(0x0003) MISSED OFFSET
	int                                                LastVehicleGear;                                          // 0x0248(0x0004) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bIsLastVehicleBreaking;                                   // 0x024C(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bIsLastVehicleSlipping;                                   // 0x024D(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData06[0x2];                                       // 0x024E(0x0002) MISSED OFFSET
	int                                                LastVehicleGroundContactMaterialSurfaceType;              // 0x0250(0x0004) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TMap<int, bool>                                    LastVehicleGearVibrateCache;                              // 0x0254(0x0050) (BlueprintVisible, ZeroConstructor)
	TMap<EVibrateTriggerEventType, float>              LastVibrateEventTimeMap;                                  // 0x0290(0x0050) (BlueprintVisible, ZeroConstructor)
	float                                              CurVehicleRaiseSuspensionVibrateCD;                       // 0x02CC(0x0004) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData07[0x64];                                      // 0x02D0(0x0064) MISSED OFFSET
	TArray<struct FVibrateEntity>                      CacheVibrateEntityList;                                   // 0x0334(0x000C) (BlueprintVisible, ZeroConstructor)
	TMap<struct FString, struct FString>               VibratePath2Json;                                         // 0x0340(0x0050) (BlueprintVisible, ZeroConstructor)
	unsigned char                                      UnknownData08[0x1C];                                      // 0x037C(0x001C) MISSED OFFSET
...
public:
	unsigned char                                      UnknownData00[0x8];                                       // 0x001C(0x0008) MISSED OFFSET
	int                                                lbsRoomMemberID;                                          // 0x0024(0x0004) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x18];                                      // 0x0028(0x0018) MISSED OFFSET
	struct FScriptDelegate                             OnSTTReportCallback;                                      // 0x0040(0x0010) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnRSTSCallback;                                           // 0x0050(0x0010) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnRSTSSpeechToTextCallback;                               // 0x0060(0x0010) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData02[0xC];                                       // 0x0070(0x000C) MISSED OFFSET
	struct FString                                     ServerInfo;                                               // 0x007C(0x000C) (ZeroConstructor, Config)
	uint32_t                                           openVoiceSDKLog;                                          // 0x0088(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	uint32_t                                           MicVolumeMUFactor;                                        // 0x008C(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	uint32_t                                           SpeekerVolumeMUFactor;                                    // 0x0090(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	int                                                RoomOperationTimeout;                                     // 0x0094(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	class UGameFrontendHUD*                            GameFrontendHUD;                                          // 0x0098(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x74];                                      // 0x009C(0x0074) MISSED OFFSET
	struct FScriptDelegate                             OpenMicFail;                                              // 0x0110(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OpenMicSuccess;                                           // 0x0120(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             CloseMicFail;                                             // 0x0130(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             CloseMicSuccess;                                          // 0x0140(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OpenSpeakerFail;                                          // 0x0150(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OpenSpeakerSuccess;                                       // 0x0160(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             CloseSpeakerFail;                                         // 0x0170(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             CloseSpeakerSuccess;                                      // 0x0180(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             JoinRoomFail;                                             // 0x0190(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             JoinRoomNotify;                                           // 0x01A0(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             QuitRoomNotify;                                           // 0x01B0(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             JoinLbsRoomNotify;                                        // 0x01C0(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             QuitLbsRoomNotify;                                        // 0x01D0(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             RoomStatusUpdatedNotify;                                  // 0x01E0(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             SetAppInfoSuccess;                                        // 0x01F0(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             SetAppInfoFail;                                           // 0x0200(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             GetReconnectInfo;                                         // 0x0210(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             ImSpeakingNotify;                                         // 0x0220(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             TestMicFail;                                              // 0x0230(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             TestMicSuccess;                                           // 0x0240(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             QuitRoomFail;                                             // 0x0250(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             DownLoadFileNotify;                                       // 0x0260(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             UploadFileNotify;                                         // 0x0270(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             ApplyMessageKeyNotify;                                    // 0x0280(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             MemberIsSpeakingNotify;                                   // 0x0290(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             LbsMemberIsSpeakingNotify;                                // 0x02A0(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnMuteSwitchResult;                                       // 0x02B0(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             ReportVoiceTimeToServer;                                  // 0x02C0(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             RecordSuccess;                                            // 0x02D0(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             RecordFail;                                               // 0x02E0(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             UploadSuccess;                                            // 0x02F0(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             UploadFail;                                               // 0x0300(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             DownloadFileSuccess;                                      // 0x0310(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             DownloadFileFail;                                         // 0x0320(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             EnableRoomMicrophone;                                     // 0x0330(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             ExitInfectionGameMode;                                    // 0x0340(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             JoinInfectionGameMode;                                    // 0x0350(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             RequestPrivacyInSetting;                                  // 0x0360(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnReportPlayerCallback;                                   // 0x0370(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnVoiceSDKEvent;                                          // 0x0380(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             BeforeVoiceSDKInitDelegate;                               // 0x0390(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             AfterVoiceSDKInitDelegate;                                // 0x03A0(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             AudioRouteChangedAfterSpeakerDelegate;                    // 0x03B0(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             AudioSessionInterruptedDelegate;                          // 0x03C0(0x0010) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData04[0x60];                                      // 0x03D0(0x0060) MISSED OFFSET
...
{
public:
	struct FScriptMulticastDelegate                    OnUrlChanged;                                             // 0x00D0(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnHttpResponed;                                           // 0x00DC(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FString                                     InitialURL;                                               // 0x00E8(0x000C) (Edit, ZeroConstructor)
