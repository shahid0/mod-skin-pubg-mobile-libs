...
public:
	...
	unsigned char                                      bStopAILogicOnUnposses : 1;                               // 0x0380(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bLOSflag : 1;                                             // 0x0380(0x0001)
	unsigned char                                      bSkipExtraLOSChecks : 1;                                  // 0x0380(0x0001)
	unsigned char                                      bAllowStrafe : 1;                                         // 0x0380(0x0001)
	unsigned char                                      bWantsPlayerState : 1;                                    // 0x0380(0x0001)
	unsigned char                                      bSetControlRotationFromPawnOrientation : 1;               // 0x0380(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      UnknownData01[0x3];                                       // 0x0381(0x0003) MISSED OFFSET
	class UPathFollowingComponent*                     PathFollowingComponent;                                   // 0x0384(0x0004) (Edit, ExportObject, ZeroConstructor, DisableEditOnInstance, EditConst, InstancedReference, IsPlainOldData)
	class UBrainComponent*                             BrainComponent;                                           // 0x0388(0x0004) (BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UAIPerceptionComponent*                      PerceptionComponent;                                      // 0x038C(0x0004) (Edit, ExportObject, ZeroConstructor, DisableEditOnInstance, EditConst, InstancedReference, IsPlainOldData)
	class UPawnActionsComponent*                       ActionsComp;                                              // 0x0390(0x0004) (BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UBlackboardComponent*                        Blackboard;                                               // 0x0394(0x0004) (BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UGameplayTasksComponent*                     CachedGameplayTasksComponent;                             // 0x0398(0x0004) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UClass*                                      DefaultNavigationFilterClass;                             // 0x039C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FScriptMulticastDelegate                    ReceiveMoveCompleted;                                     // 0x03A0(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData02[0x1];                                       // 0x03AC(0x0001) MISSED OFFSET
	bool                                               UseGameplayTasksComponent;                                // 0x03AD(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bShareNavigationSystem;                                   // 0x03AE(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x1];                                       // 0x03AF(0x0001) MISSED OFFSET
	struct FVector                                     ShareNavSysOffset;                                        // 0x03B0(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
	bool                                               bEnableActiveRegion;                                      // 0x03BC(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
{
public:
	class UBlackboardData*                             BlackboardAsset;                                          // 0x00C8(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData00[0x18];                                      // 0x00CC(0x0018) MISSED OFFSET
	TArray<class UBlackboardKeyType*>                  KeyInstances;                                             // 0x00E4(0x000C) (ZeroConstructor, Transient)
	unsigned char                                      UnknownData01[0x88];                                      // 0x00F0(0x0088) MISSED OFFSET
...
public:
	...
	class UNavMovementComponent*                       MovementComp;                                             // 0x00F8(0x0004) (ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData)
	unsigned char                                      UnknownData01[0x8];                                       // 0x00FC(0x0008) MISSED OFFSET
	class ANavigationData*                             MyNavData;                                                // 0x0104(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData02[0x140];                                     // 0x0108(0x0140) MISSED OFFSET
...
{
public:
	struct FVector                                     CrowdAgentMoveDirection;                                  // 0x0248(0x000C) (IsPlainOldData)
	class UCharacterMovementComponent*                 CharacterMovement;                                        // 0x0254(0x0004) (ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData)
	struct FNavAvoidanceMask                           AvoidanceGroup;                                           // 0x0258(0x0004) (Deprecated, IsPlainOldData)
	struct FNavAvoidanceMask                           GroupsToAvoid;                                            // 0x025C(0x0004) (Deprecated, IsPlainOldData)
	struct FNavAvoidanceMask                           GroupsToIgnore;                                           // 0x0260(0x0004) (Deprecated, IsPlainOldData)
...
public:
	...
	class UClass*                                      DominantSense;                                            // 0x00D0(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData01[0x14];                                      // 0x00D4(0x0014) MISSED OFFSET
	class AAIController*                               AIOwner;                                                  // 0x00E8(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData02[0x5C];                                      // 0x00EC(0x005C) MISSED OFFSET
...
{
public:
	TArray<class UClass*>                              RegisterAsSourceForSenses;                                // 0x00C8(0x000C) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
...
{
public:
	class UBlackboardComponent*                        BlackboardComp;                                           // 0x00C8(0x0004) (ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData)
	class AAIController*                               AIOwner;                                                  // 0x00CC(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
...
public:
	...
	TArray<class UBTNode*>                             NodeInstances;                                            // 0x0118(0x000C) (ZeroConstructor, Transient)
	unsigned char                                      UnknownData01[0xC4];                                      // 0x0124(0x00C4) MISSED OFFSET
...
{
public:
	unsigned char                                      UnknownData00[0x4];                                       // 0x0620(0x0004) MISSED OFFSET
	class UEnvQuery*                                   QueryTemplate;                                            // 0x0624(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	TArray<struct FEnvNamedValue>                      QueryParams;                                              // 0x0628(0x000C) (Edit, ZeroConstructor, EditConst)
	TArray<struct FAIDynamicParam>                     QueryConfig;                                              // 0x0634(0x000C) (Edit, ZeroConstructor)
	float                                              TimeLimitPerStep;                                         // 0x0640(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                StepToDebugDraw;                                          // 0x0644(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	EEnvQueryHightlightMode                            HighlightMode;                                            // 0x0648(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bDrawLabels : 1;                                          // 0x0649(0x0001) (Edit)
	unsigned char                                      bDrawFailedItems : 1;                                     // 0x0649(0x0001) (Edit)
	unsigned char                                      bReRunQueryOnlyOnFinishedMove : 1;                        // 0x0649(0x0001) (Edit)
	unsigned char                                      bShouldBeVisibleInGame : 1;                               // 0x0649(0x0001) (Edit)
	unsigned char                                      bTickDuringGame : 1;                                      // 0x0649(0x0001) (Edit)
	TEnumAsByte<EEnvQueryRunMode>                      QueryingMode;                                             // 0x064A(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x15];                                      // 0x064B(0x0015) MISSED OFFSET
...
{
public:
	TArray<struct FPawnActionStack>                    ActionStacks;                                             // 0x00C8(0x000C) (ZeroConstructor)
	TArray<struct FPawnActionEvent>                    ActionEvents;                                             // 0x00D4(0x000C) (ZeroConstructor)
	class UPawnAction*                                 CurrentAction;                                            // 0x00E0(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
...
{
public:
	float                                              LOSHearingThreshold;                                      // 0x00C8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              SightRadius;                                              // 0x00CC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              SensingInterval;                                          // 0x00D0(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	float                                              HearingMaxSoundAge;                                       // 0x00D4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bEnableSensingUpdates : 1;                                // 0x00D8(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly)
	unsigned char                                      bOnlySensePlayers : 1;                                    // 0x00D8(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bSeePawns : 1;                                            // 0x00D8(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bHearNoises : 1;                                          // 0x00D8(0x0001) (Edit, BlueprintVisible)
