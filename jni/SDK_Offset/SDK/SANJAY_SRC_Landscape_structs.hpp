...
{
	TArray<struct FSimpleMeshVertex>                   VertexBuffer;                                             // 0x0000(0x000C) (ZeroConstructor)
	TArray<int>                                        IndexBuffer;                                              // 0x000C(0x000C) (ZeroConstructor)
	struct FBox                                        BoundingBox;                                              // 0x0018(0x001C) (IsPlainOldData)
	bool                                               Visible;                                                  // 0x0034(0x0001) (ZeroConstructor, IsPlainOldData)
