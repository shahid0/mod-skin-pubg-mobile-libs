...
{
public:
	TEnumAsByte<ETextureAddress>                       AddressX;                                                 // 0x00A8(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<ETextureAddress>                       AddressY;                                                 // 0x00A9(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               AutoClear;                                                // 0x00AA(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x1];                                       // 0x00AB(0x0001) MISSED OFFSET
	struct FLinearColor                                ClearColor;                                               // 0x00AC(0x0010) (Edit, BlueprintVisible, IsPlainOldData)
	class UMediaPlayer*                                MediaPlayer;                                              // 0x00BC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x38];                                      // 0x00C0(0x0038) MISSED OFFSET
